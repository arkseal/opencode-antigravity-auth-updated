...
describe("resolveModelWithTier", () => {
  ...
  describe("agy-sdk model normalization", () => {
    ...
    it("passes non-Antigravity-only Gemini ids through unchanged", () => {
      const result = resolveModelForHeaderStyle("antigravity-gemini-3.7-flash", "agy-sdk");
      expect(result.actualModel).toBe("gemini-3.7-flash");
    });

    it("routes gemini-3.8-flash to public API bare id for agy-sdk", () => {
      const result = resolveModelForHeaderStyle("antigravity-gemini-3.8-flash", "agy-sdk");
  ...
  describe("Gemini 3.6 Flash backend resolution", () => {
    ...
    it("gemini-3.6-flash (bare) gets default thinkingLevel 'low' with antigravity quota", () => {
  ...
  describe("Gemini 3.8 Flash backend resolution", () => {
    it("antigravity-gemini-3.8-flash maps to the Antigravity tiered backend id by default", () => {
    ...
    it("antigravity-gemini-3.8-flash-minimal maps to tiered backend id with fallback low thinkingLevel", () => {
      const result = resolveModelWithTier("antigravity-gemini-3.8-flash-minimal");
      expect(result.actualModel).toBe("gemini-3.8-flash-tiered");
      expect(result.thinkingLevel).toBe("low");
    });

    it("antigravity-gemini-3.8-flash-low maps to tiered backend id", () => {
      const result = resolveModelWithTier("antigravity-gemini-3.8-flash-low");
      expect(result.actualModel).toBe("gemini-3.8-flash-tiered");
      expect(result.thinkingLevel).toBe("low");
    });

    it("antigravity-gemini-3.8-flash-medium uses the tiered backend id with medium thinkingLevel", () => {
      const result = resolveModelWithTier("antigravity-gemini-3.8-flash-medium");
      expect(result.actualModel).toBe("gemini-3.8-flash-tiered");
      expect(result.thinkingLevel).toBe("medium");
    });

    it("antigravity-gemini-3.8-flash-high maps to the Antigravity tiered backend id with high thinkingLevel", () => {
      const result = resolveModelWithTier("antigravity-gemini-3.8-flash-high");
      expect(result.actualModel).toBe("gemini-3.8-flash-tiered");
      expect(result.thinkingLevel).toBe("high");
    });

    it("gemini-3.8-flash (bare) gets default thinkingLevel 'low' with antigravity quota", () => {
    ...
    it("prefers gemini-cli for gemini-3.8-flash when cli_first is true", () => {
      const result = resolveModelWithTier("gemini-3.8-flash", { cli_first: true });
      expect(result.actualModel).toBe("gemini-3.8-flash");
      expect(result.thinkingLevel).toBe("low");
      expect(result.quotaPreference).toBe("gemini-cli");
      expect(result.explicitQuota).toBe(false);
...
describe("Issue #103: resolveModelForHeaderStyle", () => {
  describe("quota fallback from gemini-cli to antigravity", () => {
    ...
    it("transforms gemini-3.8-flash to the Antigravity tiered backend id", () => {
      const result = resolveModelForHeaderStyle("gemini-3.8-flash", "antigravity");
      expect(result.actualModel).toBe("gemini-3.8-flash-tiered");
      expect(result.quotaPreference).toBe("antigravity");
    });

    it("transforms gemini-3.8-flash-high to the Antigravity tiered backend id", () => {
      const result = resolveModelForHeaderStyle("gemini-3.8-flash-high", "antigravity");
      expect(result.actualModel).toBe("gemini-3.8-flash-tiered");
      expect(result.thinkingLevel).toBe("high");
      expect(result.quotaPreference).toBe("antigravity");
    });
  ...
  describe("quota fallback from antigravity to gemini-cli", () => {
    ...
    it("keeps gemini-3.8-flash as gemini-3.8-flash (bare) for gemini-cli", () => {
      const result = resolveModelForHeaderStyle("gemini-3.8-flash", "gemini-cli");
      expect(result.actualModel).toBe("gemini-3.8-flash");
      expect(result.quotaPreference).toBe("gemini-cli");
    });
  });
