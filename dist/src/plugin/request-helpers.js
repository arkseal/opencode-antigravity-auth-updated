 ...
 */
function createGeminiSyntheticErrorResponse(errorMessage, requestedModel) {
...
export function createSyntheticErrorResponse(errorMessage, requestedModel = "unknown", family) {
