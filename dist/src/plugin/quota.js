import { ANTIGRAVITY_ENDPOINT_PROD, getAntigravityHeaders, ANTIGRAVITY_PROVIDER_ID, } from "../constants.js";
 ...
 */
export async function triggerAsyncQuotaRefreshForAll(accountManager, client, providerId) {
    const now = Date.now();
