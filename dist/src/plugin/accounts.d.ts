...
export declare class AccountManager {
    ...
    updateQuotaCache(accountRef: string | number, quotaGroups: Partial<Record<QuotaGroup, QuotaGroupSummary>>): void;
    /**
     * Heuristic to determine if we should refresh all quotas in the pool.
     * Triggers when the pool is mostly blocked or unhealthy.
     */
    shouldRefreshAllQuotas(family?: ModelFamily, thresholdPercent?: number, cacheTtlMs?: number, model?: string | null): boolean;
